...
While implementing your new Venice pipeline, you may want to run locally or 
[deploy to cloud](/technical/deploy-to-cloud) to test your changes.
...
Otherwise, please see [deploy to cloud](/technical/deploy-to-cloud#environment-variables) for more information on the environment keys and expected values.
...
6. Run the workers in a new (separate) terminal
