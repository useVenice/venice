...
export type Holding = {
   ...
   */
  readonly assetClassification?: Array<AssetClassification>;
  /**
   ...
   */
  readonly holdingType?: 'stock' | 'mutualFund' | 'bond' | 'CD' | 'option' | 'moneyMarketFund' | 'other' | 'remic' | 'future' | 'commodity' | 'currency' | 'unitInvestmentTrust' | 'employeeStockOption' | 'insuranceAnnuity' | 'unknown' | 'preferredStock' | 'ETF' | 'warrants' | 'digitalAsset';
  /**
