...
export type AutoRefresh = {
   ...
   */
  readonly additionalStatus?: 'SCHEDULED' | 'TEMP_ERROR' | 'SITE_BLOCKING' | 'SITE_NOT_SUPPORTED' | 'REAL_TIME_MFA_REQUIRED' | 'USER_ACTION_REQUIRED' | 'UNSUBSCRIBED' | 'MANUAL_ACCOUNT';
  /**
