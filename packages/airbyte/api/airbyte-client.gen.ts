...
const WebhookConfigWrite = z
  .object({name: z.string(), authToken: z.string(), validationUrl: z.string()})
  .partial()
...
const SourceDefinitionSpecificationRead = z.object({
  ...
  authSpecification: AuthSpecification.optional(),
...
const SelectedFieldInfo = z.object({fieldPath: z.array(z.string())}).partial()
...
const DestinationReadList = z.object({destinations: z.array(DestinationRead)})
const DestinationIdRequestBody = z.object({destinationId: DestinationId.uuid()})
...
const DestinationCloneConfiguration = z
  .object({connectionConfiguration: DestinationConfiguration, name: z.string()})
  .partial()
...
const SourceOauthConsentRequest = z.object({
  ...
  oAuthInputConfiguration: OAuthConfiguration.optional(),
  sourceId: SourceId.uuid().optional(),
})
